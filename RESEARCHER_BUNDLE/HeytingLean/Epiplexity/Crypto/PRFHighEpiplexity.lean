...
namespace _root_.HeytingLean.Probability.InfoTheory.FinDist

variable {α : Type u} [Fintype α]

@[ext] theorem ext (P Q : _root_.HeytingLean.Probability.InfoTheory.FinDist α)
    (h : ∀ a, P.pmf a = Q.pmf a) : P = Q := by
  cases P with
...
end _root_.HeytingLean.Probability.InfoTheory.FinDist
